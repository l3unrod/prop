...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'driver' => 'sqlsrv',
        'url' => env('DATABASE_URL'),
        'host' => env('DB_HOST', '192.168.177.1'),
        'port' => env('DB_PORT', '7707'),
        'database' => env('DB_DATABASE', 'CXOA_CARE'),
        'username' => env('DB_USERNAME', 'care@adm'),
        'password' => env('DB_PASSWORD', 'care#adm#2024'),
        'charset' => 'utf8',
        'prefix' => '',
        'prefix_indexes' => true,
